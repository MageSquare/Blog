...
{
    const PERSISTENT_NAME = 'magesquare_blog_comments';
    const CACHE_TAG = 'msblog_comment_';
    ...
    public function _construct()
    {
        ...
        $this->_init(\MageSquare\Blog\Model\ResourceModel\Comments::class);

        parent::_construct();
    }

    /**
     * @return \MageSquare\Blog\Api\Data\PostInterface|Posts
     */
    ...
    public function getUrl($page = 1, ?StoreInterface $store = null)
    {
        ...
        return $url . '#ms-blog-comment-' . $this->getId();
    }
