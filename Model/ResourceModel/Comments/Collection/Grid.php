...
namespace MageSquare\Blog\Model\ResourceModel\Comments\Collection;
 ...
 * Class
 */
class Grid extends \MageSquare\Blog\Model\ResourceModel\Comments\Collection implements SearchResultInterface
{
    protected $_map = [
        'fields' => [
