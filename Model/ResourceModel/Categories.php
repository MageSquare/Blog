...
class Categories extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    const TABLE_NAME = 'magesquare_blog_categories';

    const STORE_TABLE_NAME = 'magesquare_blog_categories_store';
    ...
    public function __construct(
        ...
        \MageSquare\Blog\Helper\Data $helper,
        $connectionName = null
    ) {
    ...
    private function validateUrlKey($object)
    {
        ...
        $select = $connection->select()->from(
            ...
            ['store' => $this->getTable('magesquare_blog_categories_store')],
    ...
    public function getStores($id)
    {
        $select = $this->getConnection()->select()
            ->from(
                [$this->getTable('magesquare_blog_categories_store')],
