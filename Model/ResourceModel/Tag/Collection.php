...
namespace MageSquare\Blog\Model\ResourceModel\Tag;
...
use MageSquare\Blog\Model\ResourceModel\Traits\StoreCollectionTrait;
...
class Collection extends AbstractCollection
{
    ...
    {
        $this->_init(\MageSquare\Blog\Model\Tag::class, \MageSquare\Blog\Model\ResourceModel\Tag::class);
    }
    ...
    public function addCount()
    {
        $this->getSelect()
            ->joinLeft(
                ['posttag' => $this->getTable('magesquare_blog_posts_tag')],
    ...
    public function addWeightData($store = null)
    {
        ...
        if ($store) {
            ...
            $store = "'" . implode("','", $store) . "'";
            $postStoreTable = $this->getTable('magesquare_blog_posts_store');
            $this->getSelect()
    ...
    private function joinPostData()
    {
        ...
        $postTagTable = $this->getTable('magesquare_blog_posts_tag');
    ...
    public function setPostStatusFilter($status)
    {
        ...
        $postTable = $this->getTable('magesquare_blog_posts');
        $this->getSelect()
