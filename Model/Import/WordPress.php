...
use MageSquare\Blog\Controller\Adminhtml\Import\Import as ImportRegistry;
...
class WordPress extends AbstractImport
{
    ...
    public function processImport()
    {
        ...
        try {
            ...
            $this->logger->error(__('MageSquare Import error: ') . $exception->getMessage());
        }
    }
    ...
    protected function importPosts($data, $connection)
    {
        try {
            ...
            $this->logger->error(__('MageSquare Import error with Posts: ') . $exception->getMessage());
        }
    }
    ...
    protected function importTags($data, $connection)
    {
        try {
            ...
            $this->logger->error(__('MageSquare Import error with Tags: ') . $exception->getMessage());
        }
    }
    ...
    protected function importCategories($data, $connection)
    {
        try {
            ...
            $this->logger->error(__('MageSquare Import error with Categories: ') . $exception->getMessage());
        }
    }
    ...
    protected function importAuthors($data, $connection)
    {
        try {
            ...
            $this->logger->error(__('MageSquare Import error with Authors: ') . $exception->getMessage());
        }
    }
    ...
    protected function importComments($connection)
    {
        try {
            ...
            $this->logger->error(__('MageSquare Import error with Comments: ') . $exception->getMessage());
        }
    }
