...
use MageSquare\Blog\Model\CategoriesFactory;
use MageSquare\Blog\Model\ResourceModel\Categories as CategoriesResource;
...
class CategoriesRepository implements CategoryRepositoryInterface
{
    ...
    public function getById($categoryId)
    {
        if (!isset($this->categoriess[$categoryId])) {
            /** @var \MageSquare\Blog\Model\Categories $categories */
    ...
    public function getByUrlKeyAndStoreId(?string $urlKey, int $storeId = Store::DEFAULT_STORE_ID): CategoryInterface
    {
        ...
        $collection->addStoreFieldToFilter(CategoryInterface::URL_KEY, $urlKey);
        $collection->setLimit(1);
        /** @var CategoryInterface $categoryByUrlKey **/
    ...
    public function getList(SearchCriteriaInterface $searchCriteria)
    {
        ...
        /** @var \MageSquare\Blog\Model\ResourceModel\Categories\Collection $categoriesCollection */
