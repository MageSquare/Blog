...
use MageSquare\Blog\Api\ViewRepositoryInterface;
use MageSquare\Blog\Model\ViewFactory;
use MageSquare\Blog\Model\ResourceModel\View\CollectionFactory;
use MageSquare\Blog\Model\ResourceModel\View as ViewResource;
...
class ViewRepository implements ViewRepositoryInterface
{
    ...
    public function getById($viewId)
    {
        if (!isset($this->views[$viewId])) {
            /** @var \MageSquare\Blog\Model\View $view */
