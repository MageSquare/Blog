...
use MageSquare\Blog\Api\Data\CommentInterface;
use MageSquare\Blog\Helper\Settings;
use MageSquare\Blog\Model\CommentsFactory;
use MageSquare\Blog\Model\ResourceModel\Comments as CommentResource;
use MageSquare\Blog\Model\ResourceModel\Comments\Collection;
...
class CommentRepository implements CommentRepositoryInterface
{
    ...
    private function afterSave(CommentInterface $comment): CommentInterface
    {
        ...
        if ($isNeedNotifyCustomers) {
            $this->eventManager->dispatch('magesquare_comment_save_after', ['comment' => $comment]);
        }
    ...
    public function getById($commentId)
    {
        if (!isset($this->comments[$commentId])) {
            /** @var \MageSquare\Blog\Model\Comments $comment */
    ...
    public function getList(SearchCriteriaInterface $searchCriteria)
    {
        ...
        /** @var \MageSquare\Blog\Model\ResourceModel\Comments\Collection $commentCollection */
