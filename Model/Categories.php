...
{
    const PERSISTENT_NAME = 'magesquare_blog_categories';

    const CACHE_TAG = 'msblog_category';
    ...
    public function _construct()
    {
        ...
        $this->_init(\MageSquare\Blog\Model\ResourceModel\Categories::class);
    }
    ...
    {
        /**
         * @var \MageSquare\Blog\Model\ResourceModel\Categories\Collection $childrenCollection
         */
