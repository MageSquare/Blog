...
namespace MageSquare\Blog\Test\Unit\Model\Import;

use MageSquare\Base\Model\Serializer;
use MageSquare\Blog\Model\Import\WordPress;
use MageSquare\Blog\Model\Source\PostStatus;
use MageSquare\Blog\Test\Unit\Traits;
...
class WordPressTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testSavePost()
    {
        ...
        $postRepository = $this->createMock(\MageSquare\Blog\Api\PostRepositoryInterface::class);
        $postModel1 = $this->createMock(\MageSquare\Blog\Api\Data\PostInterface::class);
        $postModel2 = $this->createMock(\MageSquare\Blog\Api\Data\PostInterface::class);
    ...
    public function testSaveTag()
    {
        ...
        $tagRepository = $this->createMock(\MageSquare\Blog\Api\TagRepositoryInterface::class);
        $tagModel1 = $this->createMock(\MageSquare\Blog\Api\Data\TagInterface::class);
        $tagModel2 = $this->createMock(\MageSquare\Blog\Api\Data\TagInterface::class);
    ...
    public function testSaveCategory()
    {
        ...
        $categoryRepository = $this->createMock(\MageSquare\Blog\Api\CategoryRepositoryInterface::class);
        $categoryModel1 = $this->createMock(\MageSquare\Blog\Api\Data\CategoryInterface::class);
        $categoryModel2 = $this->createMock(\MageSquare\Blog\Api\Data\CategoryInterface::class);
    ...
    {
        $model = $this->createPartialMock(WordPress::class, []);
        $parentCategory = $this->createMock(\MageSquare\Blog\Api\Data\CategoryInterface::class);
    ...
    public function testSaveAuthor()
    {
        ...
        $authorRepository = $this->createMock(\MageSquare\Blog\Api\AuthorRepositoryInterface::class);
        $authorModel1 = $this->createMock(\MageSquare\Blog\Api\Data\AuthorInterface::class);
        $authorModel2 = $this->createMock(\MageSquare\Blog\Api\Data\AuthorInterface::class);
