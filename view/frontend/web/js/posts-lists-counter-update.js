define([
    ...
    $.widget('magesquare_blog.msBlogViewsList', {
        options: {
            baseUrl: window.BASE_URL,
            backendUrl: 'msblog/index/viewlist',
            selectors: {
                viewsCounterSelector: '[data-msblog-js="views-counter"]'
            }
        },
        ...
        updateViewsCounterValues: function (viewsCounts) {
            if (viewsCounts) {
                _.each(viewsCounts, function (count, postId) {
                    ...
                    $('[data-msblog-js="views-counter"][data-post-id="' + postId + '"]').html(counterText);
                });
            }
        },
    ...
    return $.magesquare_blog.msBlogViewsList;
});
