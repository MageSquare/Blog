/**
 *  MageSquare Blog Tabs Component
 */
...
define([
    ...
    $.widget('mage.msBlogTabs', {
        options: {
            selectors: {
                tabLabel: '[data-msblog-js="tab-label"]',
                contentTabsBlock: '[data-msblog-js="content-tabs-block"]',
                contentTabs: '[data-msblog-js="content-tab"]',
