define([
    ...
    $.widget('mage.amPostVote', {
        ...
        _create: function (options) {
            ...
            this.plus = this.element.find('.msblog-plus');
            this.minus = this.element.find('.msblog-minus');
        ...
        updateVote: function (response) {
            this.plus.find('.msblog-count').text(response.data.plus);
            this.minus.find('.msblog-count').text(response.data.minus);
