...
define([
    ...
    $.widget('mage.msblogComments', {
        ...
        selectors: {
            form: '[data-msblog-js="form"]',
            reply: '[data-msblog-js="reply-to"]',
            commentsWrapper: '[data-msblog-js="comments_wrapper"]',
            shortComments: '[data-msblog-js="short_comments"]',
            gdpr: '[data-msblog-js="gdpr-agree"]',
            formHead: '[data-msblog-js="form-head"]',
            toggleRepliesButton: '[data-msblog-js="toggle-replies"]',
            commentsForm: '[data-msblog-js="comments-form"]',
            commentsCount: '[data-msblog-js="comments-count"]',
            firstLevelReplies: '[data-msblog-js="replies-block"] > [data-msblog-js="replies"]',
            replies: '[data-msblog-js="replies"]',
            comment: '[data-msblog-js="comment-item"]'
        },
        classes: {
            active: '-active',
            loaded: '-loaded',
            highlighted: '-highlighted',
            comment: 'ms-blog-comment'
        },
        nodes: {
            formHeadBlock: $('<div/>', {
                class: 'msblog-form-head'
            })
        },
        ...
        setReplyCommentsCount: function () {
            ...
            $(self.selectors.firstLevelReplies).each(function (index, element) {
                ...
                formHeadBlock = self.nodes.formHeadBlock.clone();
                ...
                $(element).prepend(formHeadBlock.html($t('Showing %1 comments').replace('%1', repliesCount)));
                button.find(self.selectors.commentsCount).text(repliesCount);
            });
        },
        ...
        initialize: function (params) {
            ...
            if (window.location.hash) {
                if (window.location.hash === '#add-comment') {
                    this.showForm('msblog-comment-form', 0);
        ...
        showLoader: function (who) {
            $(who).append('<div class="msblog-loader"></div>');
        },
        ...
        submitForm: function (formValues, form) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    form.parent().children(self.selectors.formHead).remove();
