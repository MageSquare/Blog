...
namespace MageSquare\Blog\Ui\Component\Form;
...
use MageSquare\Blog\Controller\Adminhtml\Categories\Edit as EditController;
...
class Categories implements OptionSourceInterface
{
    ...
    public function getCategoriesTree($displayRoot = false)
    {
        if ($this->categoriesTree === null) {
            ...
            if ($category = $this->blogRegistry->registry(EditController::CURRENT_MAGESQUARE_BLOG_CATEGORY)) {
