...
namespace MageSquare\Blog\Plugin\View\Page\Config;
...
class Renderer
{
    const CACHE_KEY = 'magesquare_blog_should_load_css';
    ...
    public function beforeRenderAssets(
        ...
        if ($shouldLoad) {
            $this->config->addPageAsset('MageSquare_Blog::css/source/mkcss/msblog.css');
        }
