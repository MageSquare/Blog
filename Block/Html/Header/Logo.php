...
namespace MageSquare\Blog\Block\Html\Header;
...
{
    const MAGESQUARE_BLOG_LOGO_HTML = 'magesquare/blog/logo_html';
    ...
    {
        $folderName = self::MAGESQUARE_BLOG_LOGO_HTML;
        $storeLogoPath = $this->_scopeConfig->getValue(
            'msblog/accelerated_mobile_pages/logo/image',
