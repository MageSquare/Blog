...
class Form extends \MageSquare\Blog\Block\Comments
{
    const KEY_CUSTOMER_NAME = 'msblog-customer-name';

    const KEY_CUSTOMER_EMAIL = 'msblog-customer-email';

    /**
     * @var string
     */
    protected $_template = 'MageSquare_Blog::comments/form.phtml';
    ...
    public function processGdpr(): void
    {
        ...
        $this->_eventManager->dispatch(
            'magesquare_gdpr_get_checkbox',
            [
                'scope' => \MageSquare\Blog\Model\Config\GdprBlog::GDPR_BLOG_COMMENT_FORM,
                'result' => $result
            ]
        );
