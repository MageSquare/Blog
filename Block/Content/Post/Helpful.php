...
class Helpful extends \Magento\Framework\View\Element\Template
{
     ...
     * @var string
     */
    protected $_template = 'MageSquare_Blog::post/helpful.phtml';
    ...
    /**
     * @var \MageSquare\Blog\Api\VoteRepositoryInterface
     */
    ...
    public function __construct(
        ...
        \MageSquare\Blog\Api\VoteRepositoryInterface $voteRepository,
    ...
    public function getJsonConfig()
    {
        return $this->jsonEncoder->encode([
            'url' => $this->getUrl('msblog/ajax/vote')
        ]);
    }
