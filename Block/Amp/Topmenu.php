...
class Topmenu extends \Magento\Theme\Block\Html\Topmenu
{
    ...
    protected function _addSubMenu($child, $childLevel, $childrenWrapClass, $limit)
    {
        ...
        $html .= '<ul class="msblog-amp-submenu level' . $childLevel . ' ' . $childrenWrapClass . '">';
        $html .= '<li><h2 class="msblog-amp-title"><a class="msblog-amp-item -all" href="' . $child->getUrl() . '">
    ...
    private function getHtmlContent(
        ...
        foreach ($children as $child) {
            ...
            if ($hasChildren && $childLevel == 0) {
                ...
                $html .= '<h2 class="msblog-amp-title"><span>' . $childName . '</span>
                            <i class="fas fa-chevron-right msblog-amp-next"></i></h2>';
            } else {
                $html .= '<h2 class="msblog-amp-title"><a class="msblog-amp-item" href="' . $child->getUrl()
