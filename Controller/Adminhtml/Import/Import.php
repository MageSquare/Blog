 ...
 * Class Import
 */
class Import extends \MageSquare\Blog\Controller\Adminhtml\Import
{
    const AMBLOG_CRON_DBHOST = 'msblog/cron/dbhost';
    const AMBLOG_CRON_DBUSERNAME = 'msblog/cron/dbusername';
    const AMBLOG_CRON_DBPASSWORD = 'msblog/cron/dbpassword';
    const AMBLOG_CRON_DBNAME = 'msblog/cron/dbname';
    const AMBLOG_CRON_PREFIX = 'msblog/cron/prefix';
    const AMBLOG_CRON_UPDATE = 'msblog/cron/update';
    ...
    private function createScheduleItem()
    {
        ...
        $schedule->setJobCode('msblog_import');
